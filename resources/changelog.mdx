...
* Subscriptions add a guarded Monthly with 12-Month Commitment command surface for Apple's April 2026 subscription update while the public API lacks billing-mode fields
