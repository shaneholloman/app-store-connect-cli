...
* `docs(capabilities)`: Document Monthly with 12-Month Commitment subscriptions as an App Store Connect web UI workflow while Apple's public App Store Connect API lacks billing-mode fields.
