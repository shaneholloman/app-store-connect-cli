...
asc reviews list --app APP_ID --stars 1,2
```
...
<ParamField path="--stars" type="string">
  Filter by star ratings, comma-separated (1-5). Accepts one rating (`--stars 1`) or several (`--stars 1,2`).
</ParamField>
