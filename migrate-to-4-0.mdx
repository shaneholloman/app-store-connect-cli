...
<Note>
This page describes the 3.7 to 4.0 cutover. Every compatibility surface that
4.x kept behind a deprecation warning, including the ones this page says
"5.0.0 will reject", was removed in 5.0.0. See
[Migrate to 5.0](/migrate-to-5-0) for the current removals.
</Note>
